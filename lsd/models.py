...
class Report(models.Model):
    ...
    project_id = models.ForeignKey(verbose_name="项目id", to='Project', to_field='project_id', on_delete=models.CASCADE)
...
class Message(models.Model):
    ...
    report_id = models.ForeignKey(verbose_name="汇报记录id", to='Report', to_field='report_id', on_delete=models.CASCADE)
...
class UserProject(models.Model):
    ...
    pro_id = models.ForeignKey(to='Project', to_field='project_id', on_delete=models.CASCADE)
